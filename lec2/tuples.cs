// Dafny program tuples.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lec2\tuples.dfy
// tuples.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static _System._ITuple2<BigInteger, BigInteger> swap__ish(BigInteger x, BigInteger y)
    {
      return _System.Tuple2<BigInteger, BigInteger>.create(y, x);
    }
    public static _System._ITuple2<BigInteger, BigInteger> swap(_System._ITuple2<BigInteger, BigInteger> xy) {
      return _System.Tuple2<BigInteger, BigInteger>.create((xy).dtor__0, (xy).dtor__1);
    }
    public static BigInteger f1(BigInteger x, BigInteger y)
    {
      return ((x) * (x)) + ((x) * (y));
    }
    public static BigInteger f2(_System._ITuple2<BigInteger, BigInteger> xy) {
      return (((xy).dtor__0) * ((xy).dtor__0)) + (((xy).dtor__0) * ((xy).dtor__1));
    }
    public static BigInteger f3(_System._ITuple2<BigInteger, BigInteger> xy) {
      _System._ITuple2<BigInteger, BigInteger> _let_tmp_rhs0 = xy;
      BigInteger _0_x = _let_tmp_rhs0.dtor__0;
      BigInteger _1_y = _let_tmp_rhs0.dtor__1;
      return ((_0_x) * (_0_x)) + ((_0_x) * (_1_y));
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("A tuple: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_System.Tuple2<BigInteger, bool>.create(new BigInteger(3), true)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("f1(2,3) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.f1(new BigInteger(2), new BigInteger(3))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("f2(2,3) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.f2(_System.Tuple2<BigInteger, BigInteger>.create(new BigInteger(2), new BigInteger(3)))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
