// Dafny program building-intlists.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lecture04\building-intlists.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static _Iintlist singleton(BigInteger i) {
      return _module.intlist.create_Cons(i, _module.intlist.create_Empty());
    }
    public static _Iintlist three__successive(BigInteger i) {
      return _module.intlist.create_Cons(i, _module.intlist.create_Cons((i) + (BigInteger.One), _module.intlist.create_Cons((i) + (new BigInteger(2)), _module.intlist.create_Empty())));
    }
  }
