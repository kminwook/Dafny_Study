// Dafny program rainbow.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lecture03\rainbow.dfy
// rainbow.dfy
...
predicate isyellowwithdiscriminatior(c: colour)
  decreases c
{
  c.Green?
}
...
namespace _module {
  ...
  public partial class __default {
    public static bool isRedWithEquality(_Icolour c) {
      return object.Equals(c, _module.colour.create_Red());
    }
    public static bool isyellowwithdiscriminatior(_Icolour c) {
      return (c).is_Green;
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("red=")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.isyellowwithdiscriminatior(_module.colour.create_Red())));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("green=")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.isyellowwithdiscriminatior(_module.colour.create_Green())));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }

  public interface _Icolour {
    bool is_Red { get; }
    bool is_Orange { get; }
    bool is_Yellow { get; }
    bool is_Green { get; }
    ...
    bool is_Indigo { get; }
    bool is_Violet { get; }
    _Icolour DowncastClone();
  }
  public abstract class colour : _Icolour {
    public colour() {
    }
    private static readonly _Icolour theDefault = create_Red();
    public static _Icolour Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_Icolour> _TYPE = new Dafny.TypeDescriptor<_Icolour>(colour.Default());
    public static Dafny.TypeDescriptor<_Icolour> _TypeDescriptor() {
      return _TYPE;
    }
    public static _Icolour create_Red() {
      return new colour_Red();
    }
    public static _Icolour create_Orange() {
      return new colour_Orange();
    }
    public static _Icolour create_Yellow() {
      return new colour_Yellow();
    }
    public static _Icolour create_Green() {
      return new colour_Green();
    }
    public static _Icolour create_Blue() {
      return new colour_Blue();
    }
    public static _Icolour create_Indigo() {
      return new colour_Indigo();
    }
    public static _Icolour create_Violet() {
      return new colour_Violet();
    }
    public bool is_Red { get { return this is colour_Red; } }
    public bool is_Orange { get { return this is colour_Orange; } }
    public bool is_Yellow { get { return this is colour_Yellow; } }
    public bool is_Green { get { return this is colour_Green; } }
    public bool is_Blue { get { return this is colour_Blue; } }
    public bool is_Indigo { get { return this is colour_Indigo; } }
    public bool is_Violet { get { return this is colour_Violet; } }
    public static System.Collections.Generic.IEnumerable<_Icolour> AllSingletonConstructors {
      get {
        yield return colour.create_Red();
        yield return colour.create_Orange();
        yield return colour.create_Yellow();
        yield return colour.create_Green();
        yield return colour.create_Blue();
        yield return colour.create_Indigo();
        yield return colour.create_Violet();
      }
    }
    public abstract _Icolour DowncastClone();
  }
  public class colour_Red : colour {
    public colour_Red() : base() {
    }
    public override _Icolour DowncastClone() {
      if (this is _Icolour dt) { return dt; }
      return new colour_Red();
    }
    public override bool Equals(object other) {
      var oth = other as colour_Red;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public class colour_Orange : colour {
    public colour_Orange() : base() {
    }
    public override _Icolour DowncastClone() {
      if (this is _Icolour dt) { return dt; }
      return new colour_Orange();
    ...
    public override bool Equals(object other) {
      var oth = other as colour_Orange;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "colour.Orange";
      return s;
    }
  }
  public class colour_Yellow : colour {
    public colour_Yellow() : base() {
    }
    public override _Icolour DowncastClone() {
      if (this is _Icolour dt) { return dt; }
      return new colour_Yellow();
    ...
    public override bool Equals(object other) {
      var oth = other as colour_Yellow;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "colour.Yellow";
      return s;
    }
  }
  public class colour_Green : colour {
    public colour_Green() : base() {
    }
    public override _Icolour DowncastClone() {
      if (this is _Icolour dt) { return dt; }
      return new colour_Green();
    ...
    public override string ToString() {
      string s = "colour.Green";
      return s;
    }
  }
  public class colour_Blue : colour {
    public colour_Blue() : base() {
    }
    public override _Icolour DowncastClone() {
      if (this is _Icolour dt) { return dt; }
      return new colour_Blue();
    ...
    public override string ToString() {
      string s = "colour.Blue";
      return s;
    }
  }
  public class colour_Indigo : colour {
    public colour_Indigo() : base() {
    }
    public override _Icolour DowncastClone() {
      if (this is _Icolour dt) { return dt; }
      return new colour_Indigo();
    ...
    public override bool Equals(object other) {
      var oth = other as colour_Indigo;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "colour.Indigo";
      return s;
    }
  }
  public class colour_Violet : colour {
    public colour_Violet() : base() {
    }
    public override _Icolour DowncastClone() {
      if (this is _Icolour dt) { return dt; }
      return new colour_Violet();
    ...
    public override bool Equals(object other) {
      var oth = other as colour_Violet;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
