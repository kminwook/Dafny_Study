// Dafny program take.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lecture06\take.dfy
// take.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static _Ilist<__T> take<__T>(BigInteger n, _Ilist<__T> l)
    {
      ...
      {
        __T _0_h = _source0.dtor_hd;
        _Ilist<__T> _1_t = _source0.dtor_tl;
        if ((n).Sign == 0) {
          return _module.list<__T>.create_Nil();
        } else {
          return _module.list<__T>.create_Cons(_0_h, __default.take<__T>((n) - (BigInteger.One), _1_t));
        }
      }
    }
    public static _Ilist<__T> takePartical<__T>(BigInteger n, _Ilist<__T> l)
    {
      _Ilist<__T> _source0 = l;
      {
        if (_source0.is_Nil) {
      ...
      }
      {
        ...
        if ((n).Sign == 0) {
          ...
          return _module.list<__T>.create_Cons(_0_h, __default.takePartical<__T>((n) - (BigInteger.One), _1_t));
        }
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("take(5,Cons(2,Cons(3,Nil))) ==")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.take<BigInteger>(new BigInteger(5), _module.list<BigInteger>.create_Cons(new BigInteger(2), _module.list<BigInteger>.create_Cons(new BigInteger(3), _module.list<BigInteger>.create_Nil())))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("takePartical(5,Cons(2,Cons(3,Nil))) ==")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.takePartical<BigInteger>(new BigInteger(5), _module.list<BigInteger>.create_Cons(new BigInteger(2), _module.list<BigInteger>.create_Cons(new BigInteger(3), _module.list<BigInteger>.create_Nil())))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
    ...
    TAIL_CALL_START: ;
      ...
      }
      {
        ...
        return (__default.length<__T>(_1_xs)) + (BigInteger.One);
      }
    }
  ...
  public abstract class option<T> : _Ioption<T> {
    ...
    public static _Ioption<T> create_Some(T _a0) {
      return new option_Some<T>(_a0);
    }
  ...
  public class option_Some<T> : option<T> {
    ...
    public option_Some(T _a0) : base() {
      this._a0 = _a0;
    }
    public override _Ioption<__T> DowncastClone<__T>(Func<T, __T> converter0) {
      if (this is _Ioption<__T> dt) { return dt; }
      return new option_Some<__T>(converter0(_a0));
    }
    public override bool Equals(object other) {
