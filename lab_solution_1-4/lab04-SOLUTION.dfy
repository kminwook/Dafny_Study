...
function daysInMonth(m : nat, isLeapYear : bool) : nat
  requires 0 <= m <= 11
{ match m case 0 => 31 case 1 => 28 + (if isLeapYear then 1 else 0)
  case 2 => 31 case 3 => 30 case 4 => 31 case 5 => 30 case 6 => 31
  case  7 => 31 case  8 => 30
  case  9 => 31 case 10 => 30
  case 11 => 31
}
...
function interleave<T>(l1 : list<T>, l2 : list<T>) : list<T>
{
   ...
   case Cons(x,xs) => match l2 case Nil => l1 
