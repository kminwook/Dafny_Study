// Dafny program bst-simple.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lecture04\bst-simple.dfy
// bst-simple.dfy
...
function build2(k1: string, k2: string, v1: int, v2: int): bst
  ...
  decreases k1, k2, v1, v2
{
  if k1 < k2 then
    Node(k2, v2, Node(k1, v1, Lf, Lf), Lf)
  else
    Node(k1, v1, Node(k2, v2, Lf, Lf), Lf)
}
...
namespace _module {
  ...
  public partial class __default {
    public static _Ibst build2(Dafny.ISequence<Dafny.Rune> k1, Dafny.ISequence<Dafny.Rune> k2, BigInteger v1, BigInteger v2)
    {
      if (Dafny.Sequence<Dafny.Rune>.IsProperPrefixOf(k1, k2)) {
        return _module.bst.create_Node(k2, v2, _module.bst.create_Node(k1, v1, _module.bst.create_Lf(), _module.bst.create_Lf()), _module.bst.create_Lf());
      } else {
        return _module.bst.create_Node(k1, v1, _module.bst.create_Node(k2, v2, _module.bst.create_Lf(), _module.bst.create_Lf()), _module.bst.create_Lf());
      }
    }
    public static _Ibst t3 { get {
      return _module.bst.create_Node(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("j"), new BigInteger(6), _module.bst.create_Node(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("i"), new BigInteger(7), _module.bst.create_Lf(), _module.bst.create_Lf()), _module.bst.create_Node(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("k"), new BigInteger(-2), _module.bst.create_Lf(), _module.bst.create_Lf()));
    } }
  }

  public interface _Ibst {
    bool is_Lf { get; }
    bool is_Node { get; }
    Dafny.ISequence<Dafny.Rune> dtor_key { get; }
    BigInteger dtor_value { get; }
    _Ibst dtor_left { get; }
    _Ibst dtor_right { get; }
    _Ibst DowncastClone();
  }
  public abstract class bst : _Ibst {
    public bst() {
    }
    private static readonly _Ibst theDefault = create_Lf();
    public static _Ibst Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_Ibst> _TYPE = new Dafny.TypeDescriptor<_Ibst>(bst.Default());
    public static Dafny.TypeDescriptor<_Ibst> _TypeDescriptor() {
      return _TYPE;
    }
    public static _Ibst create_Lf() {
      return new bst_Lf();
    }
    public static _Ibst create_Node(Dafny.ISequence<Dafny.Rune> key, BigInteger @value, _Ibst left, _Ibst right) {
      return new bst_Node(key, @value, left, right);
    }
    public bool is_Lf { get { return this is bst_Lf; } }
    public bool is_Node { get { return this is bst_Node; } }
    public Dafny.ISequence<Dafny.Rune> dtor_key {
      get {
        var d = this;
        return ((bst_Node)d)._key;
      }
    }
    public BigInteger dtor_value {
      get {
        var d = this;
        return ((bst_Node)d)._value;
      }
    }
    public _Ibst dtor_left {
      get {
        var d = this;
        return ((bst_Node)d)._left;
      }
    }
    public _Ibst dtor_right {
      get {
        var d = this;
        return ((bst_Node)d)._right;
      }
    }
    public abstract _Ibst DowncastClone();
  }
  public class bst_Lf : bst {
    public bst_Lf() : base() {
    }
    public override _Ibst DowncastClone() {
      if (this is _Ibst dt) { return dt; }
      return new bst_Lf();
    }
    public override bool Equals(object other) {
      var oth = other as bst_Lf;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public class bst_Node : bst {
    public readonly Dafny.ISequence<Dafny.Rune> _key;
    public readonly BigInteger _value;
    public readonly _Ibst _left;
    public readonly _Ibst _right;
    public bst_Node(Dafny.ISequence<Dafny.Rune> key, BigInteger @value, _Ibst left, _Ibst right) : base() {
      this._key = key;
      this._value = @value;
      this._left = left;
      this._right = right;
    ...
    public override _Ibst DowncastClone() {
      if (this is _Ibst dt) { return dt; }
      return new bst_Node(_key, _value, _left, _right);
    }
    public override bool Equals(object other) {
      var oth = other as bst_Node;
      return oth != null && object.Equals(this._key, oth._key) && this._value == oth._value && object.Equals(this._left, oth._left) && object.Equals(this._right, oth._right);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 1;
