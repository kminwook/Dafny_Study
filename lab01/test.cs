...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lab01\test.dfy
// test.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      if ((((m).Sign == 0) && ((n).Sign == 0)) || (((m).Sign != 0) && ((Dafny.Helpers.EuclideanModulus(n, m)).Sign == 0))) {
        return true;
      } else {
        return false;
      }
    ...
    public static BigInteger area(_Ishape s) {
      _Ishape _source0 = s;
      {
        if (_source0.is_Rectangle) {
          BigInteger _0_h = _source0.dtor_height;
          BigInteger _1_w = _source0.dtor_width;
          return (_0_h) * (_1_w);
        }
      }
      {
        if (_source0.is_Square) {
          BigInteger _2_l = _source0.dtor_side;
          return (_2_l) * (_2_l);
        }
      }
      {
    ...
    public static bool isLeapYear(BigInteger y) {
      if ((Dafny.Helpers.EuclideanModulus(y, new BigInteger(400))).Sign == 0) {
        return true;
      } else if ((Dafny.Helpers.EuclideanModulus(y, new BigInteger(100))).Sign == 0) {
        return false;
      } else {
        return (Dafny.Helpers.EuclideanModulus(y, new BigInteger(4))).Sign == 0;
      }
    }
    ...
    {
      _Ilist<BigInteger> _0_intList;
      _0_intList = _module.list<BigInteger>.create_Cons(new BigInteger(10), _module.list<BigInteger>.create_Cons(new BigInteger(20), _module.list<BigInteger>.create_Cons(new BigInteger(30), _module.list<BigInteger>.create_Nil())));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("dotProduct((2,3),(5,6)) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.dotProduct(_System.Tuple2<BigInteger, BigInteger>.create(new BigInteger(2), new BigInteger(3)), _System.Tuple2<BigInteger, BigInteger>.create(new BigInteger(5), new BigInteger(6)))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("prependicular = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.perpendicular(_System.Tuple2<BigInteger, BigInteger>.create(BigInteger.Zero, new BigInteger(2)), _System.Tuple2<BigInteger, BigInteger>.create(new BigInteger(2), new BigInteger(3)))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("divides (2,4) =")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.divides(new BigInteger(2), new BigInteger(4))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("inRange (10,40,30) =")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.inRange(new BigInteger(10), new BigInteger(40), new BigInteger(30))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("withTax(10) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.withTax(new BigInteger(10))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("next(Red) =")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.next(_module.light.create_Red())));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("area(Square(10)) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.area(_module.shape.create_Square(new BigInteger(10)))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("monthLen(Feb,true) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.monthLen(_module.month.create_Feb(), false)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("isLeapYear(2000) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.isLeapYear(new BigInteger(2000))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("exp(3,4) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.exp(new BigInteger(3), new BigInteger(4))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("gradient((70,23),(52,2)) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.gradient(_System.Tuple2<BigInteger, BigInteger>.create(new BigInteger(70), new BigInteger(23)), _System.Tuple2<BigInteger, BigInteger>.create(new BigInteger(52), new BigInteger(2)))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("makeItbigger(10) =")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.makeItBigger(new BigInteger(10))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("length([1,2,3] = )")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.length<BigInteger>(_0_intList)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
