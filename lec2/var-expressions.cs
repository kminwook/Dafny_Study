// Dafny program var-expressions.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lec2\var-expressions.dfy
// var-expressions.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger expanded(BigInteger x) {
      BigInteger _0_y = (x) * (new BigInteger(10));
      if ((_0_y) > (new BigInteger(63))) {
        return (_0_y) + (new BigInteger(7));
      } else {
        return (_0_y) + (BigInteger.One);
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" expanded(100) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.expanded(new BigInteger(100))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expanded(1) =")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.expanded(BigInteger.One)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
