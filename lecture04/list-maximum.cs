// Dafny program list-maximum.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lecture04\list-maximum.dfy
// list-maximum.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      ...
      {
        _Ilist<__T> _1_t = _source0.dtor_tl;
        return (BigInteger.One) + (__default.length<__T>(_1_t));
      }
    }
    ...
    public static BigInteger maxList(_Ilist<BigInteger> l) {
      _Ilist<BigInteger> _source0 = l;
      {
        if (_source0.is_Cons) {
          BigInteger _0_hd = _source0.dtor_hd;
          _Ilist<BigInteger> tl0 = _source0.dtor_tl;
          if (tl0.is_Nil) {
            return _0_hd;
          }
        }
      ...
      {
        BigInteger _1_hd = _source0.dtor_hd;
        _Ilist<BigInteger> _2_tl = _source0.dtor_tl;
        return __default.max(_1_hd, __default.maxList(_2_tl));
      }
    }
    public static BigInteger maxListA(_Ilist<BigInteger> l, BigInteger acc)
    {
    TAIL_CALL_START: ;
      _Ilist<BigInteger> _source0 = l;
      {
      ...
      {
        BigInteger _0_hd = _source0.dtor_hd;
        _Ilist<BigInteger> _1_tl = _source0.dtor_tl;
        _Ilist<BigInteger> _in0 = _1_tl;
        BigInteger _in1 = __default.max(_0_hd, acc);
        l = _in0;
        acc = _in1;
    ...
    {
      _Ilist<BigInteger> _0_testList;
      _0_testList = _module.list<BigInteger>.create_Cons(new BigInteger(12), _module.list<BigInteger>.create_Cons(new BigInteger(3), _module.list<BigInteger>.create_Cons(new BigInteger(4), _module.list<BigInteger>.create_Cons(new BigInteger(3), _module.list<BigInteger>.create_Nil()))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("maxList  = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.maxList(_module.list<BigInteger>.create_Cons(new BigInteger(12), _module.list<BigInteger>.create_Cons(new BigInteger(3), _module.list<BigInteger>.create_Cons(new BigInteger(4), _module.list<BigInteger>.create_Cons(new BigInteger(3), _module.list<BigInteger>.create_Nil())))))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("maxListA = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.maxListA((_0_testList).dtor_tl, (_0_testList).dtor_hd)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
