// Dafny program dates.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lecture03\dates.dfy
// dates.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger centuryNumber(_Idate d) {
      return (Dafny.Helpers.EuclideanDivision((d).dtor_year, new BigInteger(100))) + (BigInteger.One);
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("1900 is in the ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.centuryNumber(__default.jan1__1900)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("th century\n")).ToVerbatimString(false));
    }
    public static _Idate jan1__1900 { get {
      return _module.date.create(BigInteger.One, BigInteger.One, new BigInteger(1900));
    } }
  }
