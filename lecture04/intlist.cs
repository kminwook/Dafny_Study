// Dafny program intlist.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lecture04\intlist.dfy
// intlist.dfy

function dumb(): int
  ensures dumb() == 0
{
  var l: intlist := Cons(0, Cons(1, Cons(2, Empty)));
  l.hd
}
...
function dumb2(): int
  ensures dumb2() == 3
{
  var l: intlist := Cons(0, Cons(3, Empty));
  l.tl.hd
}
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger dumb() {
      _Iintlist _0_l = _module.intlist.create_Cons(BigInteger.Zero, _module.intlist.create_Cons(BigInteger.One, _module.intlist.create_Cons(new BigInteger(2), _module.intlist.create_Empty())));
      return (_0_l).dtor_hd;
    }
    public static BigInteger dumb2() {
      _Iintlist _0_l = _module.intlist.create_Cons(BigInteger.Zero, _module.intlist.create_Cons(new BigInteger(3), _module.intlist.create_Empty()));
      return ((_0_l).dtor_tl).dtor_hd;
    }
    public static BigInteger head(_Iintlist x) {
      _Iintlist _source0 = x;
      {
        BigInteger _0_h = _source0.dtor_hd;
        _Iintlist _1_t = _source0.dtor_tl;
        return _0_h;
      }
    }
  }

  public interface _Iintlist {
    bool is_Empty { get; }
    bool is_Cons { get; }
    BigInteger dtor_hd { get; }
    _Iintlist dtor_tl { get; }
    _Iintlist DowncastClone();
  }
  public abstract class intlist : _Iintlist {
    public intlist() {
    }
    private static readonly _Iintlist theDefault = create_Empty();
    public static _Iintlist Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_Iintlist> _TYPE = new Dafny.TypeDescriptor<_Iintlist>(intlist.Default());
    public static Dafny.TypeDescriptor<_Iintlist> _TypeDescriptor() {
      return _TYPE;
    }
    public static _Iintlist create_Empty() {
      return new intlist_Empty();
    }
    public static _Iintlist create_Cons(BigInteger hd, _Iintlist tl) {
      return new intlist_Cons(hd, tl);
    }
    public bool is_Empty { get { return this is intlist_Empty; } }
    public bool is_Cons { get { return this is intlist_Cons; } }
    public BigInteger dtor_hd {
      get {
        var d = this;
        return ((intlist_Cons)d)._hd;
      }
    }
    public _Iintlist dtor_tl {
      get {
        var d = this;
        return ((intlist_Cons)d)._tl;
      }
    }
    public abstract _Iintlist DowncastClone();
  }
  public class intlist_Empty : intlist {
    public intlist_Empty() : base() {
    }
    public override _Iintlist DowncastClone() {
      if (this is _Iintlist dt) { return dt; }
      return new intlist_Empty();
    }
    public override bool Equals(object other) {
      var oth = other as intlist_Empty;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "intlist.Empty";
      return s;
    }
  }
  public class intlist_Cons : intlist {
    public readonly BigInteger _hd;
    public readonly _Iintlist _tl;
    public intlist_Cons(BigInteger hd, _Iintlist tl) : base() {
      this._hd = hd;
      this._tl = tl;
    }
    public override _Iintlist DowncastClone() {
      if (this is _Iintlist dt) { return dt; }
      return new intlist_Cons(_hd, _tl);
    }
    public override bool Equals(object other) {
      var oth = other as intlist_Cons;
      return oth != null && this._hd == oth._hd && object.Equals(this._tl, oth._tl);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 1;
