// Dafny program simple-expressions.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lec2\simple-expressions.dfy
// simple-expressions.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger SquareAndAddOne(BigInteger x) {
      return ((x) * (x)) + (BigInteger.One);
    }
    ...
    public static bool isOdd(BigInteger x) {
      return (Dafny.Helpers.EuclideanModulus(x, new BigInteger(2))) == (BigInteger.One);
    }
    public static bool mystery(BigInteger x) {
      return !(!(__default.isEven(x))) || (true);
    }
    public static bool g(BigInteger x) {
      return (Dafny.Helpers.EuclideanModulus(x, new BigInteger(4))) < (Dafny.Helpers.EuclideanModulus((x) + (BigInteger.One), new BigInteger(4)));
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("f(6,5) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.f(new BigInteger(6), new BigInteger(5))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("SquareAndAddOne(-10) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.SquareAndAddOne(new BigInteger(-10))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("complicated = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.mystery(__default.SquareAndAddOne(__default.f(new BigInteger(5), new BigInteger(6))))));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
