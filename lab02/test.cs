...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lab02\test.dfy
// test.dfy
  ...
  decreases n, l
{
  if n == 0 then
    ...
    match l case Nil() => Nil case Cons(x, xs) => Cons(x, take(n - 1, xs))
}
  ...
  decreases n, l
{
  if n == 0 then
    ...
    match l case Nil() => Nil case Cons(_ /* _v1 */, xs) => drop(n - 1, xs)
}
  ...
  decreases l
{
  ...
  case Nil() =>
    (Nil, Nil)
  case Cons((x, y), rest) =>
    var (xs: list<A>, ys: list<B>) := unzip(rest);
    (Cons(x, xs), Cons(y, ys))
}
...
lemma /*{:_inductionTrigger sumUpTo(n)}*/ /*{:_induction n}*/ triangle(n: nat)
  ensures 2 * sumUpTo(n) == n * (n + 1)
  decreases n
{
}

lemma /*{:_inductionTrigger min(n, length(l))}*/ /*{:_inductionTrigger take(n, l)}*/ /*{:_induction n, l}*/ takeLength<T>(n: nat, l: list<T>)
...
lemma /*{:_inductionTrigger sub(length(l), n)}*/ /*{:_inductionTrigger drop(n, l)}*/ /*{:_induction n, l}*/ dropLength<T>(n: nat, l: list<T>)
  ensures length(drop(n, l)) == sub(length(l), n)
  decreases n, l
{
}

lemma /*{:_inductionTrigger drop(n, l)}*/ /*{:_inductionTrigger take(n, l)}*/ /*{:_induction n, l}*/ takeDropAppend<T>(n: nat, l: list<T>)
  ensures l == append(take(n, l), drop(n, l))
  decreases n, l
{
}

lemma /*{:_inductionTrigger unzip(l)}*/ /*{:_induction l}*/ unzipLength<A, B>(l: list<(A, B)>)
  ensures length(unzip(l).0) == length(l) && length(unzip(l).1) == length(l)
  decreases l
{
}

lemma /*{:_inductionTrigger zipPartial(l1, l2)}*/ /*{:_induction l1, l2}*/ zipPartialLength<A, B>(l1: list<A>, l2: list<B>)
  requires length(l1) == length(l2)
  ...
  decreases t
{
  ...
  case Node(left, val, right) =>
    Node(mirror(right), val, mirror(left))
}

lemma /*{:_inductionTrigger mirror(t)}*/ /*{:_induction t}*/ mirrorSize<T>(t: tree<T>)
  ensures treeSize(t) == treeSize(mirror(t))
  decreases t
{
}

lemma /*{:_inductionTrigger mirror(mirror(t))}*/ /*{:_induction t}*/ mirrorMirror<T>(t: tree<T>)
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static _Ilist<__T> take<__T>(BigInteger n, _Ilist<__T> l)
    {
      if ((n).Sign == 0) {
        return _module.list<__T>.create_Nil();
      } else {
        _Ilist<__T> _source0 = l;
        {
          if (_source0.is_Nil) {
        ...
        }
        {
          __T _0_x = _source0.dtor_hd;
          _Ilist<__T> _1_xs = _source0.dtor_tl;
          return _module.list<__T>.create_Cons(_0_x, __default.take<__T>((n) - (BigInteger.One), _1_xs));
        }
      }
    }
    public static _Ilist<__T> drop<__T>(BigInteger n, _Ilist<__T> l)
    {
    TAIL_CALL_START: ;
      if ((n).Sign == 0) {
        return l;
        ...
        {
          _Ilist<__T> _0_xs = _source0.dtor_tl;
          BigInteger _in0 = (n) - (BigInteger.One);
          _Ilist<__T> _in1 = _0_xs;
          n = _in0;
          l = _in1;
    ...
    public static _Ilist<__T> reverse<__T>(_Ilist<__T> l) {
      _Ilist<__T> _source0 = l;
      {
        if (_source0.is_Nil) {
          return _module.list<__T>.create_Nil();
      ...
      }
      {
        __T _0_x = _source0.dtor_hd;
        _Ilist<__T> _1_xs = _source0.dtor_tl;
        return __default.append<__T>(__default.reverse<__T>(_1_xs), _module.list<__T>.create_Cons(_0_x, _module.list<__T>.create_Nil()));
      }
    }
    public static _Ilist<_System._ITuple2<__A, __B>> zip<__A, __B>(_Ilist<__A> l1, _Ilist<__B> l2)
    {
      _System._ITuple2<_Ilist<__A>, _Ilist<__B>> _source0 = _System.Tuple2<_Ilist<__A>, _Ilist<__B>>.create(l1, l2);
      {
        _Ilist<__A> _00 = _source0.dtor__0;
        if (_00.is_Cons) {
          __A _0_x = _00.dtor_hd;
          _Ilist<__A> _1_xs = _00.dtor_tl;
          _Ilist<__B> _10 = _source0.dtor__1;
          if (_10.is_Cons) {
            __B _2_y = _10.dtor_hd;
            _Ilist<__B> _3_ys = _10.dtor_tl;
            return _module.list<_System._ITuple2<__A, __B>>.create_Cons(_System.Tuple2<__A, __B>.create(_0_x, _2_y), __default.zip<__A, __B>(_1_xs, _3_ys));
          }
        }
      }
      {
        return _module.list<_System._ITuple2<__A, __B>>.create_Nil();
      }
    }
    public static _System._ITuple2<_Ilist<__A>, _Ilist<__B>> unzip<__A, __B>(_Ilist<_System._ITuple2<__A, __B>> l) {
      _Ilist<_System._ITuple2<__A, __B>> _source0 = l;
      {
        if (_source0.is_Nil) {
          return _System.Tuple2<_Ilist<__A>, _Ilist<__B>>.create(_module.list<__A>.create_Nil(), _module.list<__B>.create_Nil());
        }
      }
      {
        _System._ITuple2<__A, __B> hd0 = _source0.dtor_hd;
        __A _0_x = hd0.dtor__0;
        __B _1_y = hd0.dtor__1;
        _Ilist<_System._ITuple2<__A, __B>> _2_rest = _source0.dtor_tl;
        _System._ITuple2<_Ilist<__A>, _Ilist<__B>> _let_tmp_rhs0 = __default.unzip<__A, __B>(_2_rest);
        _Ilist<__A> _3_xs = _let_tmp_rhs0.dtor__0;
        _Ilist<__B> _4_ys = _let_tmp_rhs0.dtor__1;
        return _System.Tuple2<_Ilist<__A>, _Ilist<__B>>.create(_module.list<__A>.create_Cons(_0_x, _3_xs), _module.list<__B>.create_Cons(_1_y, _4_ys));
      }
    }
    public static _Ilist<_System._ITuple2<__A, __B>> zipPartial<__A, __B>(_Ilist<__A> l1, _Ilist<__B> l2)
    {
      if ((l1).is_Nil) {
        return _module.list<_System._ITuple2<__A, __B>>.create_Nil();
      } else {
        return _module.list<_System._ITuple2<__A, __B>>.create_Cons(_System.Tuple2<__A, __B>.create((l1).dtor_hd, (l2).dtor_hd), __default.zipPartial<__A, __B>((l1).dtor_tl, (l2).dtor_tl));
      }
    }
    ...
    public static BigInteger treeSize<__T>(_Itree<__T> t) {
      _Itree<__T> _source0 = t;
      {
        if (_source0.is_Leaf) {
          return BigInteger.Zero;
        }
      ...
      {
        _Itree<__T> _0_left = _source0.dtor_left;
        _Itree<__T> _1_right = _source0.dtor_right;
        return ((BigInteger.One) + (__default.treeSize<__T>(_0_left))) + (__default.treeSize<__T>(_1_right));
      }
    }
    public static _Itree<__T> mirror<__T>(_Itree<__T> t) {
      _Itree<__T> _source0 = t;
      {
        if (_source0.is_Leaf) {
          return _module.tree<__T>.create_Leaf();
        }
      }
      {
        _Itree<__T> _0_left = _source0.dtor_left;
        __T _1_val = _source0.dtor_val;
        _Itree<__T> _2_right = _source0.dtor_right;
        return _module.tree<__T>.create_Node(__default.mirror<__T>(_2_right), _1_val, __default.mirror<__T>(_0_left));
      }
    }
    ...
    public static BigInteger maxDepth<__T>(_Itree<__T> t) {
      _Itree<__T> _source0 = t;
      {
        if (_source0.is_Leaf) {
          return BigInteger.Zero;
      ...
      }
      {
        _Itree<__T> _0_left = _source0.dtor_left;
        _Itree<__T> _1_right = _source0.dtor_right;
        return (BigInteger.One) + (__default.max(__default.maxDepth<__T>(_0_left), __default.maxDepth<__T>(_1_right)));
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      _Ilist<BigInteger> _0_l;
      _0_l = _module.list<BigInteger>.create_Cons(new BigInteger(10), _module.list<BigInteger>.create_Cons(new BigInteger(20), _module.list<BigInteger>.create_Cons(new BigInteger(30), _module.list<BigInteger>.create_Nil())));
      _Ilist<BigInteger> _1_t1;
      _1_t1 = __default.take<BigInteger>(new BigInteger(2), _0_l);
      _Ilist<BigInteger> _2_t2;
      _2_t2 = __default.take<BigInteger>(new BigInteger(5), _0_l);
      _Ilist<BigInteger> _3_d1;
      _3_d1 = __default.drop<BigInteger>(BigInteger.One, _0_l);
      _Ilist<BigInteger> _4_d2;
      _4_d2 = __default.drop<BigInteger>(new BigInteger(3), _0_l);
      _Ilist<BigInteger> _5_r;
      _5_r = __default.reverse<BigInteger>(_0_l);
      _Ilist<Dafny.ISequence<Dafny.Rune>> _6_l__str;
      _6_l__str = _module.list<Dafny.ISequence<Dafny.Rune>>.create_Cons(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("A"), _module.list<Dafny.ISequence<Dafny.Rune>>.create_Cons(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("B"), _module.list<Dafny.ISequence<Dafny.Rune>>.create_Nil()));
      _Ilist<_System._ITuple2<BigInteger, Dafny.ISequence<Dafny.Rune>>> _7_z;
      _7_z = __default.zip<BigInteger, Dafny.ISequence<Dafny.Rune>>(_0_l, _6_l__str);
      _System._ITuple2<_Ilist<BigInteger>, _Ilist<Dafny.ISequence<Dafny.Rune>>> _8_unzipped;
      _8_unzipped = __default.unzip<BigInteger, Dafny.ISequence<Dafny.Rune>>(_7_z);
      _Ilist<BigInteger> _9_l__a;
      _9_l__a = _module.list<BigInteger>.create_Cons(BigInteger.One, _module.list<BigInteger>.create_Cons(new BigInteger(2), _module.list<BigInteger>.create_Nil()));
      _Ilist<Dafny.ISequence<Dafny.Rune>> _10_l__b;
      _10_l__b = _module.list<Dafny.ISequence<Dafny.Rune>>.create_Cons(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("X"), _module.list<Dafny.ISequence<Dafny.Rune>>.create_Cons(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Y"), _module.list<Dafny.ISequence<Dafny.Rune>>.create_Nil()));
      _Ilist<_System._ITuple2<BigInteger, Dafny.ISequence<Dafny.Rune>>> _11_zp;
      _11_zp = __default.zipPartial<BigInteger, Dafny.ISequence<Dafny.Rune>>(_9_l__a, _10_l__b);
      _Itree<BigInteger> _12_sampleTree;
      _12_sampleTree = _module.tree<BigInteger>.create_Node(_module.tree<BigInteger>.create_Node(_module.tree<BigInteger>.create_Leaf(), new BigInteger(10), _module.tree<BigInteger>.create_Leaf()), new BigInteger(20), _module.tree<BigInteger>.create_Node(_module.tree<BigInteger>.create_Leaf(), new BigInteger(30), _module.tree<BigInteger>.create_Leaf()));
      BigInteger _13_size;
      _13_size = __default.treeSize<BigInteger>(_12_sampleTree);
      _Itree<BigInteger> _14_mirroredTree;
      _14_mirroredTree = __default.mirror<BigInteger>(_12_sampleTree);
      BigInteger _15_depth;
      _15_depth = __default.maxDepth<BigInteger>(_12_sampleTree);
      _Itree<BigInteger> _16_deepTree;
      _16_deepTree = _module.tree<BigInteger>.create_Node(_module.tree<BigInteger>.create_Node(_module.tree<BigInteger>.create_Node(_module.tree<BigInteger>.create_Leaf(), new BigInteger(5), _module.tree<BigInteger>.create_Leaf()), new BigInteger(10), _module.tree<BigInteger>.create_Leaf()), new BigInteger(20), _module.tree<BigInteger>.create_Node(_module.tree<BigInteger>.create_Leaf(), new BigInteger(30), _module.tree<BigInteger>.create_Leaf()));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Original list: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_0_l));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Reversed list: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_5_r));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Zipped list:   ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_7_z));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Unzipped lists: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_8_unzipped));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("zipPartial list: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_11_zp));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("treeSize: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_13_size));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("mirroredTree: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_14_mirroredTree));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("maxDepth of sampleTree: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_15_depth));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("maxDepth of deepTree: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.maxDepth<BigInteger>(_16_deepTree)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
  ...
  public interface _Itree<T> {
    bool is_Leaf { get; }
    bool is_Node { get; }
    _Itree<T> dtor_left { get; }
    T dtor_val { get; }
    _Itree<T> dtor_right { get; }
    _Itree<__T> DowncastClone<__T>(Func<T, __T> converter0);
  }
  public abstract class tree<T> : _Itree<T> {
    public tree() {
    }
    public static _Itree<T> Default() {
      return create_Leaf();
    }
    public static Dafny.TypeDescriptor<_Itree<T>> _TypeDescriptor() {
      return new Dafny.TypeDescriptor<_Itree<T>>(tree<T>.Default());
    }
    public static _Itree<T> create_Leaf() {
      return new tree_Leaf<T>();
    }
    public static _Itree<T> create_Node(_Itree<T> left, T val, _Itree<T> right) {
      return new tree_Node<T>(left, val, right);
    }
    public bool is_Leaf { get { return this is tree_Leaf<T>; } }
    public bool is_Node { get { return this is tree_Node<T>; } }
    public _Itree<T> dtor_left {
      get {
        var d = this;
        return ((tree_Node<T>)d)._left;
      }
    }
    public T dtor_val {
      get {
        var d = this;
        return ((tree_Node<T>)d)._val;
      }
    }
    public _Itree<T> dtor_right {
      get {
        var d = this;
        return ((tree_Node<T>)d)._right;
      }
    }
    public abstract _Itree<__T> DowncastClone<__T>(Func<T, __T> converter0);
  }
  public class tree_Leaf<T> : tree<T> {
    public tree_Leaf() : base() {
    }
    public override _Itree<__T> DowncastClone<__T>(Func<T, __T> converter0) {
      if (this is _Itree<__T> dt) { return dt; }
      return new tree_Leaf<__T>();
    }
    public override bool Equals(object other) {
  ...
  public class tree_Node<T> : tree<T> {
    public readonly _Itree<T> _left;
    public readonly T _val;
    public readonly _Itree<T> _right;
    public tree_Node(_Itree<T> left, T val, _Itree<T> right) : base() {
      this._left = left;
      this._val = val;
      this._right = right;
    }
    public override _Itree<__T> DowncastClone<__T>(Func<T, __T> converter0) {
      if (this is _Itree<__T> dt) { return dt; }
      return new tree_Node<__T>((_left).DowncastClone<__T>(Dafny.Helpers.CastConverter<T, __T>), converter0(_val), (_right).DowncastClone<__T>(Dafny.Helpers.CastConverter<T, __T>));
    }
    public override bool Equals(object other) {
      var oth = other as tree_Node<T>;
      return oth != null && object.Equals(this._left, oth._left) && object.Equals(this._val, oth._val) && object.Equals(this._right, oth._right);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 1;
