// Dafny program boolean-expressions.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lec2\boolean-expressions.dfy
// boolean-expressions.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static bool f(bool a, bool b, bool c)
    {
      return ((a) == (b)) || (!(c));
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.Helpers.Print(((true) || (false)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((!(true) || (false)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("f(true,false,true) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.f(true, false, true)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
