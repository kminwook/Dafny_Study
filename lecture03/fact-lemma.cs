// Dafny program fact-lemma.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\Users\김민욱\Desktop\dafny programs\lecture03\fact-lemma.dfy
// fact-lemma.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("fact=")).ToVerbatimString(false));
      Dafny.Helpers.Print((__default.fact(new BigInteger(10))));
